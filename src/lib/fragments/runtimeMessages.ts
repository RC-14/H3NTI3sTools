...
export type ExternalRuntimeMessageHandler = (msg: unknown, sender: Runtime.MessageSender, currentAnswer?: unknown) => void | { continueProcessing: boolean, answer?: unknown };
